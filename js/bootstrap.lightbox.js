...
/*
 ...
 2015-04-02 - Lightly modified by J. Chris Ormsby for Online Buddies, Inc. Channels Prototype
...
(function() {
    ...
    this.devDebug && console.log('JC Ormsby modification of bootstrap.lightbox.js');
    var ormsbyMod = {
        containerElClass: 'ormsbyLightboxContainer',
        triggerElClass: 'ormsbyLightboxTrigger'
    };
    ...
    Lightbox = (function() {
        ...
        Lightbox.prototype.enable = function() {
            var _this = this;
            return $("body").on("click", "." + ormsbyMod.containerElClass + "[data-toggle^=lightbox] ." + ormsbyMod.triggerElClass + "", function(e) {
        ...
        Lightbox.prototype.build = function() {
            ...
            $("#lightboxOverlay").hide().on("click", function(e) {
                // ormsby mod: detectDblClick
                if (_this.detectDblClick()) {
                    _this.devDebug && console.log('detected fast dblclick');
                    return true;
                }
                _this.end();
                return false;
        ...
        // ormsby mod: detectDblClick
        Lightbox.prototype.detectDblClick = function () {
            var now = Date.now();
            var limit = 600; // ms. limit+1 ms is not a dblclick
            if (!this.firstClick) {
                return;
            }
            return now - this.firstClick < limit;
        };

        Lightbox.prototype.start = function($link) {
            var $lightbox, $window, a, current, i, imageNumber, left, top, _i, _len, _ref;
            this.firstClick = Date.now(); // ormsby mod
            ...
            imageNumber = 0;
            current = 0;
            if ($link.parents("." + ormsbyMod.containerElClass + "").attr("data-toggle") === "lightbox" && $link.parents("." + ormsbyMod.containerElClass + "").find("." + ormsbyMod.triggerElClass + "").length) {
                _ref = $link.parents("." + ormsbyMod.containerElClass + "").find("." + ormsbyMod.triggerElClass + "");
